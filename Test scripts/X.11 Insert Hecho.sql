		  ...
		  ,[OrigenOrden]
			...
			FROM STAGING.OrdenCotizacion O
				...
				LEFT JOIN Dimension.Partes P ON((O.[ID_Parte_Cotizacion] = P.ID_Parte or O.[ID_Parte_Orden] = P.ID_Parte )and
													(
														O.Fecha_Orden BETWEEN '1999-12-31' AND ISNULL(P.FechaFinValidez, '9999-12-31') OR 
														O.FechaCreacionCotizacion BETWEEN '1999-12-31' AND ISNULL(P.FechaFinValidez, '9999-12-31') OR 
														O.FechaCreacionRegistro_Cotizacion BETWEEN '1999-12-31' AND ISNULL(P.FechaFinValidez, '9999-12-31')
													)
												)
